(function() {
    ...
    announcementBtn.addEventListener('click', async () => {
        announcementOverlay.style.animation = 'fadeOutOverlay 0.4s ease forwards';
        announcementOverlay.addEventListener('animationend', function handler() {
            announcementOverlay.removeEventListener('animationend', handler);
    ...
    installBtn.addEventListener('click', () => {
        if (deferredPrompt) {
            ...
            alert('请使用浏览器菜单中的“添加到主屏幕”或“创建快捷方式”');
        }
    });
